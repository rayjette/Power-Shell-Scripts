...
Describe 'New-WinEventXPathFilter' {
    ...
    It 'Handles strings with both single and double quotes' {
    ...
    It 'Builds XPath with ProviderName' {
        $result = New-WinEventXPathFilter -ProviderName 'Microsoft-Windows-Security-Auditing'

        $result | Should -Match 'Provider'
        $result | Should -Match 'Microsoft-Windows-Security-Auditing'
    }
